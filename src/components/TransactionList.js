                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header bg-info text-white">
                                <h5 className="mx-auto text-uppercase"><strong>Detail of Transaction</strong></h5>
                            </div>
                            <div className="modal-body">
                                <h5>Customer: <strong className="text-info">{this.props.customer_name}</strong></h5>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-right text-danger text-bold">
                                                <h4>
                                                Rp <strong>{ this.getAmount(this.props.products) }</strong>
                                                </h4>
                                            </td>
                                        </tr>
                                    </tbody>
